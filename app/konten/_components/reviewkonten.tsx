...
import { Clock, Ellipsis, MessageCircleMore, Plus } from 'lucide-react';

export function ReviewKonten (){
return (
...
<div className="my-8.25 bg-white w-90 h-172.75 rounded-2xl shadow-md">
                <div className="bg-[#0D1B48] w-90 h-12.5 rounded-t-2xl">
                    <div className="flex justify-between p-3.25">
                        <h1 className="text-white font-semibold text-md">Review</h1>
                ...
                <div className="border-3 bg-[#0D1B48] rounded-2xl m-3 h-fit">
                        <div className="m-2 space-y-1">
                                <div className="space-y-1">
                                    <div className="flex justify-between">
                                        ...
                                        <div className="flex justify-evenly mr-2">
                                            ...
                                            <h1 className="text-white font-thin">14 Juli 2025</h1>
                                        </div>
                                    </div>
                            ...
                            <div className="flex justify-between space-x-10">
                                <div className="flex">
                                    <MessageCircleMore className='stroke-white'/>
                                        <h1 className="text-white font-thin">2</h1>
                                </div>
