...
<div className="bg-white h-screen lg:w-fit fixed">
    ...
    <Link href="/agenda" className="flex justify-start text-lg bg-linear-to-r from-gray-400/50 via-white to-white px-7 py-3 transition delay-150 duration-300 space-x-2">
        <div>
