...
export function NavbarSetting (){
return (

<div className="bg-white h-screen lg:w-fit fixed">
        <Image 
            src="/pemkot.png" 
            width={94}
            height={83}
        ...
        />
    <Link href="/dashboard" className="flex justify-start text-lg bg-linear-to-r hover:from-gray-400/50 hover:via-white hover:to-white px-7 py-3 transition delay-150 duration-300 space-x-2">
        <div>
    ...
    <Link href="/konten" className="flex justify-start text-lg hover:bg-linear-to-r hover:from-gray-400/50 hover:via-white hover:to-white px-7 py-3 transition delay-150 duration-300 space-x-2">
        <div>
            <StickyNote className='size-7 stroke-[#0D1B48]'/>
        </div>
        <h1 className="text-[#0D1B48] font-semibold text-md">
            Konten
        </h1>
    ...
    <Link href="/galeri" className="flex justify-start  text-lg hover:bg-linear-to-r hover:from-gray-400/50 hover:via-white hover:to-white px-7 py-3 transition delay-150 duration-300 space-x-2">
        <div>
            <ImagePlus className='size-7 stroke-[#0D1B48]'/>
        </div>
        <h1 className="text-[#0D1B48] font-semibold text-md">
            Galeri
        </h1>
    ...
    <Link href="/agenda" className="flex justify-start text-lg hover:bg-linear-to-r hover:from-gray-400/50 hover:via-white hover:to-white px-7 py-3 transition delay-150 duration-300 space-x-2">
        <div>
            <ClipboardList className='size-7 stroke-[#0D1B48]'/>
        </div>
        <h1 className="text-[#0D1B48] font-semibold text-md">
            Agenda
        </h1>
    </Link>
    <Link href="/setting" className="flex justify-start text-lg bg-linear-to-r from-gray-400/50 via-white to-white px-7 py-3 transition delay-150 duration-300 space-x-2">
        <div>
            <Settings className='size-7 stroke-[#0D1B48]'/>
        </div>
        <h1 className="text-[#0D1B48] font-semibold text-md">
            Pengaturan
        </h1>
